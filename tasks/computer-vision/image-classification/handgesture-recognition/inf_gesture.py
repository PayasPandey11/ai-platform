...
while(cv2.waitKey(10)<0):
	...
	for i in indices:
		...
		w = box[2]
		h = box[3]
		# cv2.rectangle(image, (int(x),int(y)), (int(x+w),int(y+h)), (255-50*class_ids[i[0]],
		# 															30*class_ids[i[0]], 50*class_ids[i[0]]), 2)
		cv2.putText(image, classes[class_ids[i[0]]], (int(x-10),int(y-10)), cv2.FONT_HERSHEY_SIMPLEX, 4,
